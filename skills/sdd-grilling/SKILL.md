...
Ask the whole frontier in one round. **At the end of each round** (after the last question + recommendation of that round), output a final line with the wait marker:
